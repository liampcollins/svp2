...
class CaseStudiesControllerTest < ActionController::TestCase
  ...
  test "should create case_study" do
    assert_difference('CaseStudy.count') do
      post :create, case_study: { cs_image: @case_study.cs_image, description: @case_study.description, location: @case_study.location, name: @case_study.name, prog_type: @case_study.prog_type }
    end
  ...
  test "should update case_study" do
    put :update, id: @case_study, case_study: { cs_image: @case_study.cs_image, description: @case_study.description, location: @case_study.location, name: @case_study.name, prog_type: @case_study.prog_type }
    assert_redirected_to case_study_path(assigns(:case_study))
  end
